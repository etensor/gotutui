...
/*
	from var exmpl -> fn(p1,p2,...,pn) -> def obj
...
/// div, url, tab, tabGap, title, info, dialog, button, active button, list, list
/// checkmark, listDone (fn),
/// paragraphs/history
// historyStyle
...
var (
	...
	// General.	// "#874BFD" "#7D56F4" "#43BF6D" "#73F59F"

	subtle    = lipgloss.AdaptiveColor{Light: "#383838", Dark: "#D9DCCF"}
	highlight = lipgloss.AdaptiveColor{Light: "#CCC01f", Dark: "#420707"}
	special   = lipgloss.AdaptiveColor{Light: "#13BFBC", Dark: "#13BFBC"} // "#022230"
	...
	url = lipgloss.NewStyle().Foreground(lipgloss.Color("#13BFBC")).Render
	...
	infoStyle = lipgloss.NewStyle().
			...
			BorderTop(true).
			BorderForeground(lipgloss.Color("#54bd09")). // linea
			Foreground(lipgloss.Color("#F7D00C"))
		//BorderForeground(subtle)
...
func main() {
	...
	// Okay, let's print it	/// this is important
